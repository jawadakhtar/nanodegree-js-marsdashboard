...
This app makes use of all the functional concepts and practices.
...
```git clone https://github.com/jawadakhtar/nanodegree-js-marsdashboard```
...
3. In your repo, you will see a .env file with a place for your API key. Rename or copy the file to one called `.env` and enter in your key. Now that you have your key, just remember to add it as a parameter to every request you make to NASA.
